...
if (file_exists('../config/config.php')){
    ...
    if(isset($_REQUEST['email'])){
        ...
        $message = get_all_email_content_contactexp($namemain,$name ,$actualmessage); //mail function in config file
          $message2 = get_all_email_content_contactexp2($email,$type ,$phn_number,$actualmessage); //mail function in config file
